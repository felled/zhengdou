...
<div class="content mb-height">
    <div class="pojflow-conten hover-blur">
        <div class="pojflow-title">
            <h2>正豆公司黑暗乘骑类产品项目整体操作模式流程图</h2>
            <p>The overall operation mode flow chart of the dark bean riding product project of Zhengdou Company</p>
        </div>
        <div class="pojflow-img">
            <img class="poj-pc-img" src="<?php bloginfo('template_url'); ?>/images/projectflow/pc/flow.png"/>
            <img class="poj-mb-img" src="<?php bloginfo('template_url'); ?>/images/projectflow/mb/flow.png"/>
        </div>
    </div>
</div>
<div class="footer">
